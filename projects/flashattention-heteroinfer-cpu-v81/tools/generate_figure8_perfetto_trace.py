...
def parse_logs(input_dir):
    ...
    return timer_rows, host_rows, event_count_rows, event_rows
...
def build_trace_for_qo(qo_len, event_rows, host_rows, pid):
    rows = sorted(
    ...
    meta_args = {
        ...
        "unit_mapping": (
            ...
            "Mixed HVX/HMX=core_acc/o_scale because these Figure 8 component timers wrap both vector setup/state work and HMX dot work; "
...
def main():
    ...
    timer_rows, host_rows, event_count_rows, event_rows = parse_logs(args.input_dir)
    ...
    for index, qo_len in enumerate(qo_lens):
        trace = build_trace_for_qo(qo_len, event_rows, host_rows, 100 + index)
