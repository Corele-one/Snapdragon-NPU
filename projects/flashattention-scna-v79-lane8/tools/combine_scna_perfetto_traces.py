...
def main():
    ...
    events += remap(lane8["traceEvents"], 2000, "SCNA lane8 (independent replay)")
    events.append({
        "name": "comparison_note", "cat": "metadata", "ph": "i", "s": "g", "pid": 0, "tid": 0, "ts": 0,
        "args": {
            "layouts_execute_concurrently": False,
            "note": "Serial and lane8 are independent replays from the same binary/shape/seed; overlapping timestamps do not imply concurrent execution.",
