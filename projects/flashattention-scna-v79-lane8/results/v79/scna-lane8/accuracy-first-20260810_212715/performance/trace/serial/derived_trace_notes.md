...
The `scna_serial_q*.ntff` and `scna_serial_q*.perfetto.json` files in this directory are Chrome Trace Event JSON files that Perfetto UI can open directly.
...
- `scna_serial_q4.ntff`
- `scna_serial_q4.perfetto.json`
- `scna_serial_q8.ntff`
- `scna_serial_q8.perfetto.json`
- `scna_serial_q16.ntff`
- `scna_serial_q16.perfetto.json`
- `scna_serial_q32.ntff`
- `scna_serial_q32.perfetto.json`
- `scna_serial_all_q.ntff`
- `scna_serial_all_q.perfetto.json`
