  ...
  for (int i = 0; i < cfg->warmup + cfg->iters; ++i) {
    ...
    for (int r = 0; r < record_count; ++r) {
      ...
      fprintf(stderr,
              ...
              "qk_dot=%ld safe_sm=%ld scna_exp=%ld param_prepare=%ld core_acc=%ld o_scale=%ld o_store=%ld\n",
              ...
              rec->k_load, rec->v_load, rec->qk_dot, rec->safe_sm, rec->scna_exp, rec->param_prepare,
