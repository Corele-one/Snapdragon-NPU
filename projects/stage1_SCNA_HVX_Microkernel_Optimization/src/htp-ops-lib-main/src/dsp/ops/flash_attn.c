...
#endif
#define SCNA_CONSUME_P_BLOCK(c_value, p_row0_value, p_row1_value) do { \
              ...
              if (numeric_debug && kv_head_idx == 0 && ir == 0 && r == 0) { \
                ...
                vmem(debug_p) = v_p_row0_consume; \
                vmem(debug_score) = row_buffer0[scna_c / 64]; \
    ...
    SCNA_KERNEL_IMPL == SCNA_KERNEL_IMPL_COMBINED_CONFIRM
            if (enable_scna_exp) {
              ...
              for (; scna_c_begin + 64 < n_cols; scna_c_begin += 128) {
                ...
                SCNA_CONSUME_P_BLOCK(c0, y00, y01);
                SCNA_CONSUME_P_BLOCK(c1, y10, y11);
              }
            }
#endif
            for (int c = scna_c_begin; c < n_cols; c += 64) {
    ...
    SCNA_KERNEL_IMPL == SCNA_KERNEL_IMPL_D7_PAIRRET_SCALE_PROBE
      ...
      SCNA_KERNEL_IMPL == SCNA_KERNEL_IMPL_COMBINED_CONFIRM
              ...
              SCNA_CONSUME_P_BLOCK(c, v_p_row0_hf, v_p_row1_hf);
            }
