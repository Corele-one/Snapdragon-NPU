...
The `baseline_q*.ntff` and `baseline_q*.perfetto.json` files in this directory are Chrome Trace Event JSON files that Perfetto UI can open directly.
...
- `baseline_q4.ntff`
- `baseline_q4.perfetto.json`
- `baseline_q8.ntff`
- `baseline_q8.perfetto.json`
- `baseline_q16.ntff`
- `baseline_q16.perfetto.json`
- `baseline_q32.ntff`
- `baseline_q32.perfetto.json`
- `baseline_all_q.ntff`
- `baseline_all_q.perfetto.json`
