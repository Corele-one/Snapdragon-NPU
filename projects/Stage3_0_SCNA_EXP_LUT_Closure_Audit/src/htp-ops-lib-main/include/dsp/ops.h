...
int mat_mul_qk_0_d16a32_out_stationary(float *restrict out, const float *restrict x,
                                       const uint8_t *restrict w, int m, int k, int n,
                                       enum ggml_type w_type, int64_t trace_id, int mode_flags,
...
int64_t audit_lut_init_us(void);
int64_t audit_lut_table_bytes(void);
