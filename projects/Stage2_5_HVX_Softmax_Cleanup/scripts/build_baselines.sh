...
# The production SCNA artifact is also the carrier for Origin HVX and EXP-LUT;
# those horizontal baselines are selected at runtime from the same binary.
...
echo "Built fresh Stage 2 baseline carrier under $artifact_root"
