...
enum LlmNpuModeFlags {
  ...
  /* Caller guarantees that the materialized broadcast mask is all zero.
   * Stage 2.5 uses this only for its explicit benchmark-target fast path. */
  LLM_NPU_MODE_MASK_FULL_FASTPATH = 1 << 7,
