...
The `scna_fp16_q*.ntff` and `scna_fp16_q*.perfetto.json` files in this directory are Chrome Trace Event JSON files that Perfetto UI can open directly.
...
- `scna_fp16_q32.ntff`
- `scna_fp16_q32.perfetto.json`
- `scna_fp16_all_q.ntff`
- `scna_fp16_all_q.perfetto.json`
