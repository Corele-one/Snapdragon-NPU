...
case "$kernel_impl" in
  static_d8_ref|d7_serial|d7_scalar_w|d7_pairret_noinline|d7_pairret_inline|d7_quad_pipeline|d7_prebroadcast|qf16_tree_control|piecewise_control|combined_confirm) ;;
